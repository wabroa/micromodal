...
return function(){var i=["a[href]","area[href]",'input:not([disabled]):not([type="hidden"]):not([aria-hidden])',"select:not([disabled]):not([aria-hidden])","textarea:not([disabled]):not([aria-hidden])","button:not([disabled]):not([aria-hidden])","iframe","object","embed","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],n=function(){function n(t){var i=t.targetModal,a=t.triggers,r=void 0===a?[]:a,s=t.onShow,l=void 0===s?function(){}:s,c=t.onClose,d=void 0===c?function(){}:c,u=t.openTrigger,f=void 0===u?"data-micromodal-trigger":u,h=t.closeTrigger,v=void 0===h?"data-micromodal-close":h,g=t.disableScroll,m=void 0!==g&&g,b=t.disableFocus,y=void 0!==b&&b,w=t.awaitCloseAnimation,k=void 0!==w&&w,p=t.debugMode,E=void 0!==p&&p
e(this,n),this.modal=document.getElementById(i),this.config={debugMode:E,disableScroll:m,openTrigger:f,closeTrigger:v,onShow:l,onClose:d,awaitCloseAnimation:k,disableFocus:y},r.length>0&&this.registerTriggers.apply(this,o(r)),this.onClick=this.onClick.bind(this),this.onKeydown=this.onKeydown.bind(this)}return t(n,[{key:"registerTriggers",value:function(){for(var e=this,t=arguments.length,o=Array(t),i=0;i<t;i++)o[i]=arguments[i]
...
e.shiftKey&&0===o&&(t[t.length-1].focus(),e.preventDefault()),e.shiftKey||o!==t.length-1||(t[0].focus(),e.preventDefault())}else t[0].focus()}}]),n}(),a=null,r=function(e,t){var o=[]
...
for(var o in t)s(o)
return!0}
return{init:function(e){var t=Object.assign({},{openTrigger:"data-micromodal-trigger"},e),i=[].concat(o(document.querySelectorAll("["+t.openTrigger+"]"))),a=r(i,t.openTrigger)
if(!0!==t.debugMode||!1!==c(i,a))for(var s in a){var l=a[s]
t.targetModal=s,t.triggers=[].concat(o(l)),new n(t)}},show:function(e,t){var o=t||{}
o.targetModal=e,!0===o.debugMode&&!1===s(e)||(a=new n(o),a.showModal())},close:function(){a.closeModal()}}}()})
